...
- **Comments:**
  - *Claude, 7 Sep 2026, 03:18 am:* Done - the job documents section now shows a proper thumbnail grid (image/video previews) instead of a bare filename list, with folders/pills to filter and click-through to view full size.
...
- **Comments:**
  - *Claude, 7 Sep 2026, 03:18 am:* Done - PO line items now support marking an item backordered with an ETA date.
...
- **Comments:**
  - *Claude, 7 Sep 2026, 03:18 am:* Done - the Add task panel already lets the job field be left blank for an office/general task.
...
- **Comments:**
  - *Claude, 7 Sep 2026, 03:18 am:* Done - timesheets can be added/edited from "your timesheet this week", and once an entry has been pushed to Xero its clock in/out time is locked, but the job and stage stay editable.
